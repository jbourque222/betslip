...
window.onload = function() {
  var itemSel = document.getElementById("abc");
  var subitemSel = document.getElementById("def");

  for (var x in data2) {
    itemSel.options[itemSel.options.length] = new Option(data2[x].item, x);
  }
  itemSel.onchange = function() {
    //empty 
    subitemSel.length = 1;
    //display correct values
    for (var y of data2[this.value].subitems) {
